...
Reason for Draft Status: Prior model no longer carries independent runtime authority.
Required Decision Before Activation: Explicit approval to promote an amendment.
