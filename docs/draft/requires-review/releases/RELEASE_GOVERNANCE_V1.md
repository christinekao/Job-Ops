...
Reason for Draft Status: Self-declared active status lacks an approved authority record and references superseded material.
Required Decision Before Activation: Owner approval of release governance.
